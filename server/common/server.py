...
class Server:
    ...
    def __handle_client_connection(self, client_sock):
        ...
        """
        try:
            while True:  # Keep the connection open for multiple batches
                try:
                    ...
                    # If the batch is empty, respond OK but do not process
                    if len(bets_data) == 0:
                    ...
                    break  # Exit loop in case of errors
